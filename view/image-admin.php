...
<head>
    ...
    <title> Admin Image | Web Backend Development 1</title>
</head>
...
<body>
    <div id="wrapper">
        ...
        <main>
            ...
            <form id="primaryImg" action="/phpmotors/uploads/" method="post" enctype="multipart/form-data">
                <label for="invItem">Vehicle</label>
                <?php echo $prodSelect; ?>
                <fieldset>
                    <label>Is this the main image for the vehicle?</label> <br> <br>
